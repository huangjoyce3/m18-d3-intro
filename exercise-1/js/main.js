...
$(function() {
  ...
  mySvg.append('circle').attr('r', 30)
  	   .attr('cx',75).attr('cy',30)
  	   .style('opacity', .5).style('fill','blue');
  // Append a `rect` element to your `svg`, setting the properties noted in index.html
  mySvg.append('rect').attr('x',70).attr('y',60)
       .attr('width', 10).attr('height', 250).style('opacity', .5).style('fill','orange');
});
